...
import { RiskHeatmapPanel } from "./panels/risk-heatmap-panel";
...
import { PortDetailPanel } from "./panels/port-detail-panel";
...
registry.register("risk_heatmap", RiskHeatmapPanel);
...
registry.register("port_detail", PortDetailPanel);
