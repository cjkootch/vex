...
/**
 * PATCH /api/contacts/:id — proxy to apps/api `PATCH /contacts/:id`.
 * Edits the identity columns on a contact. Membership mutations use
 * the dedicated /memberships endpoints.
 */
  ...
  return NextResponse.json(
    {
      ...
      message: "PATCH /api/contacts/:id not implemented in local stub",
    },
    { status: 501 },
  );
}
